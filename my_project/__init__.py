...
def _process_input_config(app_config: Dict[str, Any], additional_config: Dict[str, Any]) -> None:
    ...
    root_user = MYSQL_ROOT_USER#os.getenv(MYSQL_ROOT_USER, additional_config[MYSQL_ROOT_USER])
    root_password = MYSQL_ROOT_PASSWORD#os.getenv(MYSQL_ROOT_PASSWORD, additional_config[MYSQL_ROOT_PASSWORD])
